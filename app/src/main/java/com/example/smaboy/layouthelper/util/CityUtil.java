...
public class CityUtil {
    ...
    public static List<City> getCityList() {
        ...
        final int FU_JIAN_ICON = R.mipmap.ic_launcher_round;
        ...
        final int AN_HUI_ICON = R.mipmap.ic_launcher_round;
    ...
    public static List<City> getRandomCityList() {
        ...
        int provinceSize = random.nextInt(5) + 6;
        for (int i = 0; i < provinceSize; i++) {
            String province = getRandomCityName();
            int citySize = random.nextInt(3) + 1;
            for (int j = 0; j < citySize; j++) {
                dataList.add(new City(province + " : city " + j, province, R.mipmap.ic_launcher));
            }
        }
        return dataList;
    }
